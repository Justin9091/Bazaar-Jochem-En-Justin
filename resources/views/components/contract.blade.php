<div class="bg-gray-800 rounded-lg flex flex-col items-center justify-center p-5">
    <a href="{{ route('download.contract') }}" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mb-4" download="contract.pdf">@lang('csv.download_contract')</a>

    <form action="{{ route('upload.contract') }}" method="POST" enctype="multipart/form-data" class="flex flex-col items-center justify-center">
        @csrf
