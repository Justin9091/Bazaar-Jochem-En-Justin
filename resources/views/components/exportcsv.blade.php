<div class="grid grid-cols-2 gap-4">
    <form action="{{ route('sellers.importcsv', ['userId' => $userid]) }}" method="POST" enctype="multipart/form-data" class="mt-4">
        @csrf
        <div class="mb-4">
            <label for="csv_file" class="block text-white font-semibold">Kies CSV bestand om te importeren:</label>
        ...
        <button type="submit" class="btn btn-primary inline-block px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 transition duration-300 ease-in-out">Import CSV</button>
