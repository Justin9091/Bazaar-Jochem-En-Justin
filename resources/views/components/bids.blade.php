<div class="w-1/4 bg-gray-600 p-4 border border-gray-200 rounded-lg shadow-md">
    ...
    <x-form.form method="post" action="/bid/{{ $advertisement['id'] }}">
        @if(auth()->check())
            <x-form.text-input name="bid" placeholder="@lang('advertisement.enter_bid')" type="" value="" class="mt-2 px-4 py-2 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"></x-form.text-input>
