<div class="bg-white dark:bg-gray-800 rounded-lg p-4 mb-4 border border-black">
    ...
    <x-form action="{{ route('add_review') }}" method="post" class="form-container">
        ...
        <button onclick="submitReview()" type="submit" class="py-2 px-4 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">@lang('review.submit_review')</button>
    </x-form>
</div>
<script>
    let rating = 0;
